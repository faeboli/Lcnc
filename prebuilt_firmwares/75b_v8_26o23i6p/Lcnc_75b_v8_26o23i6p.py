...
#gpios out
_gpios_out = [ \
    ("gpio_out", 0, Pins("j2:0"), IOStandard("LVCMOS33")),
    ("gpio_out", 1, Pins("j2:1"), IOStandard("LVCMOS33")),
    ("gpio_out", 2, Pins("j2:2"), IOStandard("LVCMOS33")),
    ("gpio_out", 3, Pins("j2:4"), IOStandard("LVCMOS33")),
    ("gpio_out", 4, Pins("j2:5"), IOStandard("LVCMOS33")),
    ("gpio_out", 5, Pins("j2:6"), IOStandard("LVCMOS33")),
    ("gpio_out", 6, Pins("j3:0"), IOStandard("LVCMOS33")),
    ("gpio_out", 7, Pins("j3:1"), IOStandard("LVCMOS33")),
    ("gpio_out", 8, Pins("j3:2"), IOStandard("LVCMOS33")),
    ("gpio_out", 9, Pins("j3:4"), IOStandard("LVCMOS33")),
    ("gpio_out", 10, Pins("j3:5"), IOStandard("LVCMOS33")),
    ("gpio_out", 11, Pins("j3:6"), IOStandard("LVCMOS33")),
    ("gpio_out", 12, Pins("j4:0"), IOStandard("LVCMOS33")),
    ("gpio_out", 13, Pins("j4:1"), IOStandard("LVCMOS33")),
    ("gpio_out", 14, Pins("j4:2"), IOStandard("LVCMOS33")),
    ("gpio_out", 15, Pins("j4:4"), IOStandard("LVCMOS33")),
    ("gpio_out", 16, Pins("j4:5"), IOStandard("LVCMOS33")),
    ("gpio_out", 17, Pins("j4:6"), IOStandard("LVCMOS33")),
    ("gpio_out", 18, Pins("j4:7"), IOStandard("LVCMOS33")),
    ("gpio_out", 19, Pins("j4:8"), IOStandard("LVCMOS33")),
    ("gpio_out", 20, Pins("j4:9"), IOStandard("LVCMOS33")),
    ("gpio_out", 21, Pins("j4:10"), IOStandard("LVCMOS33")),
    ("gpio_out", 22, Pins("j4:11"), IOStandard("LVCMOS33")),
    ("gpio_out", 23, Pins("j4:12"), IOStandard("LVCMOS33")),
    ("gpio_out", 24, Pins("j4:13"), IOStandard("LVCMOS33")),
    ("gpio_out", 25, Pins("j4:14"), IOStandard("LVCMOS33")),
]

_pwm_out = [ \
    ("pwm_out", 0, Pins("j1:0"), IOStandard("LVCMOS33")),
    ("pwm_out", 1, Pins("j1:1"), IOStandard("LVCMOS33")),
    ("pwm_out", 2, Pins("j1:2"), IOStandard("LVCMOS33")),
    ("pwm_out", 3, Pins("j1:4"), IOStandard("LVCMOS33")),
    ("pwm_out", 4, Pins("j1:5"), IOStandard("LVCMOS33")),
    ("pwm_out", 5, Pins("j1:6"), IOStandard("LVCMOS33")),
]
