...
encoders=([
    ...
    ("encoder", 6,
     Subsignal("A", Pins("j5:0")),
     Subsignal("B", Pins("j5:1")),
     IOStandard("LVCMOS33")
     ),
    ("encoder", 7,
     Subsignal("A", Pins("j5:2")), 
     Subsignal("B", Pins("j5:4")),
     IOStandard("LVCMOS33")
     ),
    ("encoder", 8,
     Subsignal("A", Pins("j5:5")),
     Subsignal("B", Pins("j5:6")),
     IOStandard("LVCMOS33")
     ),
])
...
stepgens=([
    ...
    ("stepgen", 6,
     Subsignal("step", Pins("j16:0")),
     Subsignal("dir", Pins("j16:1")),
     IOStandard("LVCMOS33")
     ),
    ("stepgen", 7,
     Subsignal("step", Pins("j16:2")),
     Subsignal("dir", Pins("j16:4")),
     IOStandard("LVCMOS33")
     ),
    ("stepgen", 8,
     Subsignal("step", Pins("j16:5")),
     Subsignal("dir", Pins("j16:6")),
     IOStandard("LVCMOS33")
     ),
])
#gpios in
_gpios_in = [
    ...
    ("gpio_in", 11, Pins("j6:0"), IOStandard("LVCMOS33")),
    ("gpio_in", 12, Pins("j6:1"), IOStandard("LVCMOS33")),
    ("gpio_in", 13, Pins("j6:2"), IOStandard("LVCMOS33")),
    ("gpio_in", 14, Pins("j6:4"), IOStandard("LVCMOS33")),
    ("gpio_in", 15, Pins("j6:5"), IOStandard("LVCMOS33")),
    ("gpio_in", 16, Pins("j6:6"), IOStandard("LVCMOS33")),
    ("gpio_in", 17, Pins("j7:0"), IOStandard("LVCMOS33")),
    ("gpio_in", 18, Pins("j7:1"), IOStandard("LVCMOS33")),
    ("gpio_in", 19, Pins("j7:2"), IOStandard("LVCMOS33")),
    ("gpio_in", 20, Pins("j7:4"), IOStandard("LVCMOS33")),
    ("gpio_in", 21, Pins("j7:5"), IOStandard("LVCMOS33")),
    ("gpio_in", 22, Pins("j7:6"), IOStandard("LVCMOS33")),
    ("gpio_in", 23, Pins("j8:0"), IOStandard("LVCMOS33")),
    ("gpio_in", 24, Pins("j8:1"), IOStandard("LVCMOS33")),
    ("gpio_in", 25, Pins("j8:2"), IOStandard("LVCMOS33")),
    ("gpio_in", 26, Pins("j8:4"), IOStandard("LVCMOS33")),
    ("gpio_in", 27, Pins("j8:5"), IOStandard("LVCMOS33")),
    ("gpio_in", 28, Pins("j8:6"), IOStandard("LVCMOS33")),
]
#gpios out
_gpios_out = [ \
    ...
    ("gpio_out", 10, Pins("j13:0"), IOStandard("LVCMOS33")),
    ("gpio_out", 11, Pins("j13:1"), IOStandard("LVCMOS33")),
    ("gpio_out", 12, Pins("j13:2"), IOStandard("LVCMOS33")),
    ("gpio_out", 13, Pins("j13:4"), IOStandard("LVCMOS33")),
    ("gpio_out", 14, Pins("j13:5"), IOStandard("LVCMOS33")),
    ("gpio_out", 15, Pins("j13:6"), IOStandard("LVCMOS33")),
    ("gpio_out", 16, Pins("j14:0"), IOStandard("LVCMOS33")),
    ("gpio_out", 17, Pins("j14:1"), IOStandard("LVCMOS33")),
    ("gpio_out", 18, Pins("j14:2"), IOStandard("LVCMOS33")),
    ("gpio_out", 19, Pins("j14:4"), IOStandard("LVCMOS33")),
    ("gpio_out", 20, Pins("j14:5"), IOStandard("LVCMOS33")),
    ("gpio_out", 21, Pins("j14:6"), IOStandard("LVCMOS33")),
    ("gpio_out", 22, Pins("j14:7"), IOStandard("LVCMOS33")),
    ("gpio_out", 23, Pins("j14:8"), IOStandard("LVCMOS33")),
    ("gpio_out", 24, Pins("j14:9"), IOStandard("LVCMOS33")),
    ("gpio_out", 25, Pins("j14:10"), IOStandard("LVCMOS33")),
    ("gpio_out", 26, Pins("j14:11"), IOStandard("LVCMOS33")),
    ("gpio_out", 27, Pins("j14:12"), IOStandard("LVCMOS33")),
    ("gpio_out", 28, Pins("j14:13"), IOStandard("LVCMOS33")),
    ("gpio_out", 29, Pins("j14:14"), IOStandard("LVCMOS33")),
]

_pwm_out = [ \
    ("pwm_out", 0, Pins("j11:0"), IOStandard("LVCMOS33")),
    ("pwm_out", 1, Pins("j11:4"), IOStandard("LVCMOS33")),
    ("pwm_out", 2, Pins("j15:0"), IOStandard("LVCMOS33")),
    ("pwm_out", 3, Pins("j15:1"), IOStandard("LVCMOS33")),
    ("pwm_out", 4, Pins("j15:2"), IOStandard("LVCMOS33")),
    ("pwm_out", 5, Pins("j15:4"), IOStandard("LVCMOS33")),
    ("pwm_out", 6, Pins("j15:5"), IOStandard("LVCMOS33")),
    ("pwm_out", 7, Pins("j15:6"), IOStandard("LVCMOS33")),
]
...
def main():
    ...
    target_group.add_argument("--revision",          default="7.1", type=str,          help="Board revision (6.0, 6.1, 7.0 or 8.0).")
