...
#gpios in
_gpios_in = [
    ("gpio_in", 0, Pins("j6:1"), IOStandard("LVCMOS33")),
    ("gpio_in", 1, Pins("j6:2"), IOStandard("LVCMOS33")),
    ("gpio_in", 2, Pins("j6:4"), IOStandard("LVCMOS33")),
    ("gpio_in", 3, Pins("j6:5"), IOStandard("LVCMOS33")),
    ("gpio_in", 4, Pins("j6:6"), IOStandard("LVCMOS33")),
    ("gpio_in", 5, Pins("j7:0"), IOStandard("LVCMOS33")),
    ("gpio_in", 6, Pins("j7:1"), IOStandard("LVCMOS33")),
    ("gpio_in", 7, Pins("j7:2"), IOStandard("LVCMOS33")),
    ("gpio_in", 8, Pins("j7:4"), IOStandard("LVCMOS33")),
    ("gpio_in", 9, Pins("j7:5"), IOStandard("LVCMOS33")),
    ("gpio_in", 10, Pins("j7:6"), IOStandard("LVCMOS33")),
]
#gpios out
_gpios_out = [ \
    ("gpio_out", 0, Pins("j2:4"), IOStandard("LVCMOS33")),
    ("gpio_out", 1, Pins("j2:5"), IOStandard("LVCMOS33")),
    ("gpio_out", 2, Pins("j2:6"), IOStandard("LVCMOS33")),
    ("gpio_out", 3, Pins("j3:0"), IOStandard("LVCMOS33")),
    ("gpio_out", 4, Pins("j3:1"), IOStandard("LVCMOS33")),
    ("gpio_out", 5, Pins("j3:2"), IOStandard("LVCMOS33")),
    ("gpio_out", 6, Pins("j3:4"), IOStandard("LVCMOS33")),
    ("gpio_out", 7, Pins("j3:5"), IOStandard("LVCMOS33")),
    ("gpio_out", 8, Pins("j3:6"), IOStandard("LVCMOS33")),
    ("gpio_out", 9, Pins("j4:0"), IOStandard("LVCMOS33")),
    ("gpio_out", 10, Pins("j4:1"), IOStandard("LVCMOS33")),
    ("gpio_out", 11, Pins("j4:2"), IOStandard("LVCMOS33")),
    ("gpio_out", 12, Pins("j4:4"), IOStandard("LVCMOS33")),
    ("gpio_out", 13, Pins("j4:5"), IOStandard("LVCMOS33")),
    ("gpio_out", 14, Pins("j4:6"), IOStandard("LVCMOS33")),
]

_pwm_out = [ \
    ("pwm_out", 0, Pins("j2:0"), IOStandard("LVCMOS33")),
    ("pwm_out", 1, Pins("j2:1"), IOStandard("LVCMOS33")),
    ("pwm_out", 2, Pins("j2:2"), IOStandard("LVCMOS33")),
]

_ext_reset_in = [("ext_reset_in", 0, Pins("j6:0"), IOStandard("LVCMOS33"))]
