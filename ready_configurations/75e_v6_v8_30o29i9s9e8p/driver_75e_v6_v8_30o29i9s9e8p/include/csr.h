//--------------------------------------------------------------------------------
// Auto-generated by LiteX (a426ec9e) on 2022-11-10 13:20:00
//--------------------------------------------------------------------------------
...
#define CSR_MMIO_INST_VELOCITY_6_ADDR (CSR_BASE + 0x18L)
#define CSR_MMIO_INST_VELOCITY_6_SIZE 1
static inline uint32_t MMIO_inst_velocity_6_read(void) {
	return csr_read_simple(CSR_BASE + 0x18L);
}
static inline void MMIO_inst_velocity_6_write(uint32_t v) {
	csr_write_simple(v, CSR_BASE + 0x18L);
}
#define CSR_MMIO_INST_VELOCITY_7_ADDR (CSR_BASE + 0x1cL)
#define CSR_MMIO_INST_VELOCITY_7_SIZE 1
static inline uint32_t MMIO_inst_velocity_7_read(void) {
	return csr_read_simple(CSR_BASE + 0x1cL);
}
static inline void MMIO_inst_velocity_7_write(uint32_t v) {
	csr_write_simple(v, CSR_BASE + 0x1cL);
}
#define CSR_MMIO_INST_VELOCITY_8_ADDR (CSR_BASE + 0x20L)
#define CSR_MMIO_INST_VELOCITY_8_SIZE 1
static inline uint32_t MMIO_inst_velocity_8_read(void) {
	return csr_read_simple(CSR_BASE + 0x20L);
}
static inline void MMIO_inst_velocity_8_write(uint32_t v) {
	csr_write_simple(v, CSR_BASE + 0x20L);
}
#define CSR_MMIO_INST_MAX_ACC_0_ADDR (CSR_BASE + 0x24L)
...
static inline uint32_t MMIO_inst_max_acc_0_acc_extract(uint32_t oldword) {
	uint32_t mask = ((uint32_t)(1 << 30)-1);
	return ( (oldword >> 0) & mask );
}
static inline uint32_t MMIO_inst_max_acc_0_acc_read(void) {
	uint32_t word = MMIO_inst_max_acc_0_read();
	return MMIO_inst_max_acc_0_acc_extract(word);
}
static inline uint32_t MMIO_inst_max_acc_0_acc_replace(uint32_t oldword, uint32_t plain_value) {
	uint32_t mask = ((uint32_t)(1 << 30)-1);
	return (oldword & (~(mask << 0))) | (mask & plain_value)<< 0 ;
}
static inline void MMIO_inst_max_acc_0_acc_write(uint32_t plain_value) {
	uint32_t oldword = MMIO_inst_max_acc_0_read();
	uint32_t newword = MMIO_inst_max_acc_0_acc_replace(oldword, plain_value);
	MMIO_inst_max_acc_0_write(newword);
}
#define CSR_MMIO_INST_MAX_ACC_0_ACC_MULT_OFFSET 30
#define CSR_MMIO_INST_MAX_ACC_0_ACC_MULT_SIZE 2
static inline uint32_t MMIO_inst_max_acc_0_acc_mult_extract(uint32_t oldword) {
	uint32_t mask = ((uint32_t)(1 << 2)-1);
	return ( (oldword >> 30) & mask );
}
static inline uint32_t MMIO_inst_max_acc_0_acc_mult_read(void) {
	uint32_t word = MMIO_inst_max_acc_0_read();
	return MMIO_inst_max_acc_0_acc_mult_extract(word);
}
static inline uint32_t MMIO_inst_max_acc_0_acc_mult_replace(uint32_t oldword, uint32_t plain_value) {
	uint32_t mask = ((uint32_t)(1 << 2)-1);
	return (oldword & (~(mask << 30))) | (mask & plain_value)<< 30 ;
}
static inline void MMIO_inst_max_acc_0_acc_mult_write(uint32_t plain_value) {
	uint32_t oldword = MMIO_inst_max_acc_0_read();
	uint32_t newword = MMIO_inst_max_acc_0_acc_mult_replace(oldword, plain_value);
	MMIO_inst_max_acc_0_write(newword);
}
#define CSR_MMIO_INST_MAX_ACC_1_ADDR (CSR_BASE + 0x28L)
...
#define CSR_MMIO_INST_MAX_ACC_1_ACC_OFFSET 0
#define CSR_MMIO_INST_MAX_ACC_1_ACC_SIZE 30
static inline uint32_t MMIO_inst_max_acc_1_acc_extract(uint32_t oldword) {
	uint32_t mask = ((uint32_t)(1 << 30)-1);
	return ( (oldword >> 0) & mask );
}
static inline uint32_t MMIO_inst_max_acc_1_acc_read(void) {
	uint32_t word = MMIO_inst_max_acc_1_read();
	return MMIO_inst_max_acc_1_acc_extract(word);
}
static inline uint32_t MMIO_inst_max_acc_1_acc_replace(uint32_t oldword, uint32_t plain_value) {
	uint32_t mask = ((uint32_t)(1 << 30)-1);
	return (oldword & (~(mask << 0))) | (mask & plain_value)<< 0 ;
}
static inline void MMIO_inst_max_acc_1_acc_write(uint32_t plain_value) {
	uint32_t oldword = MMIO_inst_max_acc_1_read();
	uint32_t newword = MMIO_inst_max_acc_1_acc_replace(oldword, plain_value);
	MMIO_inst_max_acc_1_write(newword);
}
#define CSR_MMIO_INST_MAX_ACC_1_ACC_MULT_OFFSET 30
#define CSR_MMIO_INST_MAX_ACC_1_ACC_MULT_SIZE 2
static inline uint32_t MMIO_inst_max_acc_1_acc_mult_extract(uint32_t oldword) {
	uint32_t mask = ((uint32_t)(1 << 2)-1);
	return ( (oldword >> 30) & mask );
}
static inline uint32_t MMIO_inst_max_acc_1_acc_mult_read(void) {
	uint32_t word = MMIO_inst_max_acc_1_read();
	return MMIO_inst_max_acc_1_acc_mult_extract(word);
}
static inline uint32_t MMIO_inst_max_acc_1_acc_mult_replace(uint32_t oldword, uint32_t plain_value) {
	uint32_t mask = ((uint32_t)(1 << 2)-1);
	return (oldword & (~(mask << 30))) | (mask & plain_value)<< 30 ;
}
static inline void MMIO_inst_max_acc_1_acc_mult_write(uint32_t plain_value) {
	uint32_t oldword = MMIO_inst_max_acc_1_read();
	uint32_t newword = MMIO_inst_max_acc_1_acc_mult_replace(oldword, plain_value);
	MMIO_inst_max_acc_1_write(newword);
}
#define CSR_MMIO_INST_MAX_ACC_2_ADDR (CSR_BASE + 0x2cL)
...
#define CSR_MMIO_INST_MAX_ACC_2_ACC_OFFSET 0
#define CSR_MMIO_INST_MAX_ACC_2_ACC_SIZE 30
static inline uint32_t MMIO_inst_max_acc_2_acc_extract(uint32_t oldword) {
	uint32_t mask = ((uint32_t)(1 << 30)-1);
	return ( (oldword >> 0) & mask );
}
static inline uint32_t MMIO_inst_max_acc_2_acc_read(void) {
	uint32_t word = MMIO_inst_max_acc_2_read();
	return MMIO_inst_max_acc_2_acc_extract(word);
}
static inline uint32_t MMIO_inst_max_acc_2_acc_replace(uint32_t oldword, uint32_t plain_value) {
	uint32_t mask = ((uint32_t)(1 << 30)-1);
	return (oldword & (~(mask << 0))) | (mask & plain_value)<< 0 ;
}
static inline void MMIO_inst_max_acc_2_acc_write(uint32_t plain_value) {
	uint32_t oldword = MMIO_inst_max_acc_2_read();
	uint32_t newword = MMIO_inst_max_acc_2_acc_replace(oldword, plain_value);
	MMIO_inst_max_acc_2_write(newword);
}
#define CSR_MMIO_INST_MAX_ACC_2_ACC_MULT_OFFSET 30
#define CSR_MMIO_INST_MAX_ACC_2_ACC_MULT_SIZE 2
static inline uint32_t MMIO_inst_max_acc_2_acc_mult_extract(uint32_t oldword) {
	uint32_t mask = ((uint32_t)(1 << 2)-1);
	return ( (oldword >> 30) & mask );
}
static inline uint32_t MMIO_inst_max_acc_2_acc_mult_read(void) {
	uint32_t word = MMIO_inst_max_acc_2_read();
	return MMIO_inst_max_acc_2_acc_mult_extract(word);
}
static inline uint32_t MMIO_inst_max_acc_2_acc_mult_replace(uint32_t oldword, uint32_t plain_value) {
	uint32_t mask = ((uint32_t)(1 << 2)-1);
	return (oldword & (~(mask << 30))) | (mask & plain_value)<< 30 ;
}
static inline void MMIO_inst_max_acc_2_acc_mult_write(uint32_t plain_value) {
	uint32_t oldword = MMIO_inst_max_acc_2_read();
	uint32_t newword = MMIO_inst_max_acc_2_acc_mult_replace(oldword, plain_value);
	MMIO_inst_max_acc_2_write(newword);
}
#define CSR_MMIO_INST_MAX_ACC_3_ADDR (CSR_BASE + 0x30L)
...
#define CSR_MMIO_INST_MAX_ACC_3_ACC_OFFSET 0
#define CSR_MMIO_INST_MAX_ACC_3_ACC_SIZE 30
static inline uint32_t MMIO_inst_max_acc_3_acc_extract(uint32_t oldword) {
	uint32_t mask = ((uint32_t)(1 << 30)-1);
	return ( (oldword >> 0) & mask );
}
static inline uint32_t MMIO_inst_max_acc_3_acc_read(void) {
	uint32_t word = MMIO_inst_max_acc_3_read();
	return MMIO_inst_max_acc_3_acc_extract(word);
}
static inline uint32_t MMIO_inst_max_acc_3_acc_replace(uint32_t oldword, uint32_t plain_value) {
	uint32_t mask = ((uint32_t)(1 << 30)-1);
	return (oldword & (~(mask << 0))) | (mask & plain_value)<< 0 ;
}
static inline void MMIO_inst_max_acc_3_acc_write(uint32_t plain_value) {
	uint32_t oldword = MMIO_inst_max_acc_3_read();
	uint32_t newword = MMIO_inst_max_acc_3_acc_replace(oldword, plain_value);
	MMIO_inst_max_acc_3_write(newword);
}
#define CSR_MMIO_INST_MAX_ACC_3_ACC_MULT_OFFSET 30
#define CSR_MMIO_INST_MAX_ACC_3_ACC_MULT_SIZE 2
static inline uint32_t MMIO_inst_max_acc_3_acc_mult_extract(uint32_t oldword) {
	uint32_t mask = ((uint32_t)(1 << 2)-1);
	return ( (oldword >> 30) & mask );
}
static inline uint32_t MMIO_inst_max_acc_3_acc_mult_read(void) {
	uint32_t word = MMIO_inst_max_acc_3_read();
	return MMIO_inst_max_acc_3_acc_mult_extract(word);
}
static inline uint32_t MMIO_inst_max_acc_3_acc_mult_replace(uint32_t oldword, uint32_t plain_value) {
	uint32_t mask = ((uint32_t)(1 << 2)-1);
	return (oldword & (~(mask << 30))) | (mask & plain_value)<< 30 ;
}
static inline void MMIO_inst_max_acc_3_acc_mult_write(uint32_t plain_value) {
	uint32_t oldword = MMIO_inst_max_acc_3_read();
	uint32_t newword = MMIO_inst_max_acc_3_acc_mult_replace(oldword, plain_value);
	MMIO_inst_max_acc_3_write(newword);
}
#define CSR_MMIO_INST_MAX_ACC_4_ADDR (CSR_BASE + 0x34L)
...
#define CSR_MMIO_INST_MAX_ACC_4_ACC_OFFSET 0
#define CSR_MMIO_INST_MAX_ACC_4_ACC_SIZE 30
static inline uint32_t MMIO_inst_max_acc_4_acc_extract(uint32_t oldword) {
	uint32_t mask = ((uint32_t)(1 << 30)-1);
	return ( (oldword >> 0) & mask );
}
static inline uint32_t MMIO_inst_max_acc_4_acc_read(void) {
	uint32_t word = MMIO_inst_max_acc_4_read();
	return MMIO_inst_max_acc_4_acc_extract(word);
}
static inline uint32_t MMIO_inst_max_acc_4_acc_replace(uint32_t oldword, uint32_t plain_value) {
	uint32_t mask = ((uint32_t)(1 << 30)-1);
	return (oldword & (~(mask << 0))) | (mask & plain_value)<< 0 ;
}
static inline void MMIO_inst_max_acc_4_acc_write(uint32_t plain_value) {
	uint32_t oldword = MMIO_inst_max_acc_4_read();
	uint32_t newword = MMIO_inst_max_acc_4_acc_replace(oldword, plain_value);
	MMIO_inst_max_acc_4_write(newword);
}
#define CSR_MMIO_INST_MAX_ACC_4_ACC_MULT_OFFSET 30
#define CSR_MMIO_INST_MAX_ACC_4_ACC_MULT_SIZE 2
static inline uint32_t MMIO_inst_max_acc_4_acc_mult_extract(uint32_t oldword) {
	uint32_t mask = ((uint32_t)(1 << 2)-1);
	return ( (oldword >> 30) & mask );
}
static inline uint32_t MMIO_inst_max_acc_4_acc_mult_read(void) {
	uint32_t word = MMIO_inst_max_acc_4_read();
	return MMIO_inst_max_acc_4_acc_mult_extract(word);
}
static inline uint32_t MMIO_inst_max_acc_4_acc_mult_replace(uint32_t oldword, uint32_t plain_value) {
	uint32_t mask = ((uint32_t)(1 << 2)-1);
	return (oldword & (~(mask << 30))) | (mask & plain_value)<< 30 ;
}
static inline void MMIO_inst_max_acc_4_acc_mult_write(uint32_t plain_value) {
	uint32_t oldword = MMIO_inst_max_acc_4_read();
	uint32_t newword = MMIO_inst_max_acc_4_acc_mult_replace(oldword, plain_value);
	MMIO_inst_max_acc_4_write(newword);
}
#define CSR_MMIO_INST_MAX_ACC_5_ADDR (CSR_BASE + 0x38L)
...
#define CSR_MMIO_INST_MAX_ACC_5_ACC_OFFSET 0
#define CSR_MMIO_INST_MAX_ACC_5_ACC_SIZE 30
static inline uint32_t MMIO_inst_max_acc_5_acc_extract(uint32_t oldword) {
	uint32_t mask = ((uint32_t)(1 << 30)-1);
	return ( (oldword >> 0) & mask );
}
static inline uint32_t MMIO_inst_max_acc_5_acc_read(void) {
	uint32_t word = MMIO_inst_max_acc_5_read();
	return MMIO_inst_max_acc_5_acc_extract(word);
}
static inline uint32_t MMIO_inst_max_acc_5_acc_replace(uint32_t oldword, uint32_t plain_value) {
	uint32_t mask = ((uint32_t)(1 << 30)-1);
	return (oldword & (~(mask << 0))) | (mask & plain_value)<< 0 ;
}
static inline void MMIO_inst_max_acc_5_acc_write(uint32_t plain_value) {
	uint32_t oldword = MMIO_inst_max_acc_5_read();
	uint32_t newword = MMIO_inst_max_acc_5_acc_replace(oldword, plain_value);
	MMIO_inst_max_acc_5_write(newword);
}
#define CSR_MMIO_INST_MAX_ACC_5_ACC_MULT_OFFSET 30
#define CSR_MMIO_INST_MAX_ACC_5_ACC_MULT_SIZE 2
static inline uint32_t MMIO_inst_max_acc_5_acc_mult_extract(uint32_t oldword) {
	uint32_t mask = ((uint32_t)(1 << 2)-1);
	return ( (oldword >> 30) & mask );
}
static inline uint32_t MMIO_inst_max_acc_5_acc_mult_read(void) {
	uint32_t word = MMIO_inst_max_acc_5_read();
	return MMIO_inst_max_acc_5_acc_mult_extract(word);
}
static inline uint32_t MMIO_inst_max_acc_5_acc_mult_replace(uint32_t oldword, uint32_t plain_value) {
	uint32_t mask = ((uint32_t)(1 << 2)-1);
	return (oldword & (~(mask << 30))) | (mask & plain_value)<< 30 ;
}
static inline void MMIO_inst_max_acc_5_acc_mult_write(uint32_t plain_value) {
	uint32_t oldword = MMIO_inst_max_acc_5_read();
	uint32_t newword = MMIO_inst_max_acc_5_acc_mult_replace(oldword, plain_value);
	MMIO_inst_max_acc_5_write(newword);
}
#define CSR_MMIO_INST_MAX_ACC_6_ADDR (CSR_BASE + 0x3cL)
#define CSR_MMIO_INST_MAX_ACC_6_SIZE 1
static inline uint32_t MMIO_inst_max_acc_6_read(void) {
	return csr_read_simple(CSR_BASE + 0x3cL);
}
static inline void MMIO_inst_max_acc_6_write(uint32_t v) {
	csr_write_simple(v, CSR_BASE + 0x3cL);
}
#define CSR_MMIO_INST_MAX_ACC_6_ACC_OFFSET 0
#define CSR_MMIO_INST_MAX_ACC_6_ACC_SIZE 30
static inline uint32_t MMIO_inst_max_acc_6_acc_extract(uint32_t oldword) {
	uint32_t mask = ((uint32_t)(1 << 30)-1);
	return ( (oldword >> 0) & mask );
}
static inline uint32_t MMIO_inst_max_acc_6_acc_read(void) {
	uint32_t word = MMIO_inst_max_acc_6_read();
	return MMIO_inst_max_acc_6_acc_extract(word);
}
static inline uint32_t MMIO_inst_max_acc_6_acc_replace(uint32_t oldword, uint32_t plain_value) {
	uint32_t mask = ((uint32_t)(1 << 30)-1);
	return (oldword & (~(mask << 0))) | (mask & plain_value)<< 0 ;
}
static inline void MMIO_inst_max_acc_6_acc_write(uint32_t plain_value) {
	uint32_t oldword = MMIO_inst_max_acc_6_read();
	uint32_t newword = MMIO_inst_max_acc_6_acc_replace(oldword, plain_value);
	MMIO_inst_max_acc_6_write(newword);
}
#define CSR_MMIO_INST_MAX_ACC_6_ACC_MULT_OFFSET 30
#define CSR_MMIO_INST_MAX_ACC_6_ACC_MULT_SIZE 2
static inline uint32_t MMIO_inst_max_acc_6_acc_mult_extract(uint32_t oldword) {
	uint32_t mask = ((uint32_t)(1 << 2)-1);
	return ( (oldword >> 30) & mask );
}
static inline uint32_t MMIO_inst_max_acc_6_acc_mult_read(void) {
	uint32_t word = MMIO_inst_max_acc_6_read();
	return MMIO_inst_max_acc_6_acc_mult_extract(word);
}
static inline uint32_t MMIO_inst_max_acc_6_acc_mult_replace(uint32_t oldword, uint32_t plain_value) {
	uint32_t mask = ((uint32_t)(1 << 2)-1);
	return (oldword & (~(mask << 30))) | (mask & plain_value)<< 30 ;
}
static inline void MMIO_inst_max_acc_6_acc_mult_write(uint32_t plain_value) {
	uint32_t oldword = MMIO_inst_max_acc_6_read();
	uint32_t newword = MMIO_inst_max_acc_6_acc_mult_replace(oldword, plain_value);
	MMIO_inst_max_acc_6_write(newword);
}
#define CSR_MMIO_INST_MAX_ACC_7_ADDR (CSR_BASE + 0x40L)
#define CSR_MMIO_INST_MAX_ACC_7_SIZE 1
static inline uint32_t MMIO_inst_max_acc_7_read(void) {
	return csr_read_simple(CSR_BASE + 0x40L);
}
static inline void MMIO_inst_max_acc_7_write(uint32_t v) {
	csr_write_simple(v, CSR_BASE + 0x40L);
}
#define CSR_MMIO_INST_MAX_ACC_7_ACC_OFFSET 0
#define CSR_MMIO_INST_MAX_ACC_7_ACC_SIZE 30
static inline uint32_t MMIO_inst_max_acc_7_acc_extract(uint32_t oldword) {
	uint32_t mask = ((uint32_t)(1 << 30)-1);
	return ( (oldword >> 0) & mask );
}
static inline uint32_t MMIO_inst_max_acc_7_acc_read(void) {
	uint32_t word = MMIO_inst_max_acc_7_read();
	return MMIO_inst_max_acc_7_acc_extract(word);
}
static inline uint32_t MMIO_inst_max_acc_7_acc_replace(uint32_t oldword, uint32_t plain_value) {
	uint32_t mask = ((uint32_t)(1 << 30)-1);
	return (oldword & (~(mask << 0))) | (mask & plain_value)<< 0 ;
}
static inline void MMIO_inst_max_acc_7_acc_write(uint32_t plain_value) {
	uint32_t oldword = MMIO_inst_max_acc_7_read();
	uint32_t newword = MMIO_inst_max_acc_7_acc_replace(oldword, plain_value);
	MMIO_inst_max_acc_7_write(newword);
}
#define CSR_MMIO_INST_MAX_ACC_7_ACC_MULT_OFFSET 30
#define CSR_MMIO_INST_MAX_ACC_7_ACC_MULT_SIZE 2
static inline uint32_t MMIO_inst_max_acc_7_acc_mult_extract(uint32_t oldword) {
	uint32_t mask = ((uint32_t)(1 << 2)-1);
	return ( (oldword >> 30) & mask );
}
static inline uint32_t MMIO_inst_max_acc_7_acc_mult_read(void) {
	uint32_t word = MMIO_inst_max_acc_7_read();
	return MMIO_inst_max_acc_7_acc_mult_extract(word);
}
static inline uint32_t MMIO_inst_max_acc_7_acc_mult_replace(uint32_t oldword, uint32_t plain_value) {
	uint32_t mask = ((uint32_t)(1 << 2)-1);
	return (oldword & (~(mask << 30))) | (mask & plain_value)<< 30 ;
}
static inline void MMIO_inst_max_acc_7_acc_mult_write(uint32_t plain_value) {
	uint32_t oldword = MMIO_inst_max_acc_7_read();
	uint32_t newword = MMIO_inst_max_acc_7_acc_mult_replace(oldword, plain_value);
	MMIO_inst_max_acc_7_write(newword);
}
#define CSR_MMIO_INST_MAX_ACC_8_ADDR (CSR_BASE + 0x44L)
#define CSR_MMIO_INST_MAX_ACC_8_SIZE 1
static inline uint32_t MMIO_inst_max_acc_8_read(void) {
	return csr_read_simple(CSR_BASE + 0x44L);
}
static inline void MMIO_inst_max_acc_8_write(uint32_t v) {
	csr_write_simple(v, CSR_BASE + 0x44L);
}
#define CSR_MMIO_INST_MAX_ACC_8_ACC_OFFSET 0
#define CSR_MMIO_INST_MAX_ACC_8_ACC_SIZE 30
static inline uint32_t MMIO_inst_max_acc_8_acc_extract(uint32_t oldword) {
	uint32_t mask = ((uint32_t)(1 << 30)-1);
	return ( (oldword >> 0) & mask );
}
static inline uint32_t MMIO_inst_max_acc_8_acc_read(void) {
	uint32_t word = MMIO_inst_max_acc_8_read();
	return MMIO_inst_max_acc_8_acc_extract(word);
}
static inline uint32_t MMIO_inst_max_acc_8_acc_replace(uint32_t oldword, uint32_t plain_value) {
	uint32_t mask = ((uint32_t)(1 << 30)-1);
	return (oldword & (~(mask << 0))) | (mask & plain_value)<< 0 ;
}
static inline void MMIO_inst_max_acc_8_acc_write(uint32_t plain_value) {
	uint32_t oldword = MMIO_inst_max_acc_8_read();
	uint32_t newword = MMIO_inst_max_acc_8_acc_replace(oldword, plain_value);
	MMIO_inst_max_acc_8_write(newword);
}
#define CSR_MMIO_INST_MAX_ACC_8_ACC_MULT_OFFSET 30
#define CSR_MMIO_INST_MAX_ACC_8_ACC_MULT_SIZE 2
static inline uint32_t MMIO_inst_max_acc_8_acc_mult_extract(uint32_t oldword) {
	uint32_t mask = ((uint32_t)(1 << 2)-1);
	return ( (oldword >> 30) & mask );
}
static inline uint32_t MMIO_inst_max_acc_8_acc_mult_read(void) {
	uint32_t word = MMIO_inst_max_acc_8_read();
	return MMIO_inst_max_acc_8_acc_mult_extract(word);
}
static inline uint32_t MMIO_inst_max_acc_8_acc_mult_replace(uint32_t oldword, uint32_t plain_value) {
	uint32_t mask = ((uint32_t)(1 << 2)-1);
	return (oldword & (~(mask << 30))) | (mask & plain_value)<< 30 ;
}
static inline void MMIO_inst_max_acc_8_acc_mult_write(uint32_t plain_value) {
	uint32_t oldword = MMIO_inst_max_acc_8_read();
	uint32_t newword = MMIO_inst_max_acc_8_acc_mult_replace(oldword, plain_value);
	MMIO_inst_max_acc_8_write(newword);
}
#define CSR_MMIO_INST_STEP_RES_EN_ADDR (CSR_BASE + 0x48L)
...
#define CSR_MMIO_INST_STEPDIRINV_ADDR (CSR_BASE + 0x4cL)
...
#define CSR_MMIO_INST_STEPTIMES_ADDR (CSR_BASE + 0x50L)
...
#define CSR_MMIO_INST_GPIOS_OUT_ADDR (CSR_BASE + 0x54L)
...
#define CSR_MMIO_INST_PWM_0_ADDR (CSR_BASE + 0x58L)
...
#define CSR_MMIO_INST_PWM_1_ADDR (CSR_BASE + 0x5cL)
...
#define CSR_MMIO_INST_PWM_2_ADDR (CSR_BASE + 0x60L)
...
#define CSR_MMIO_INST_PWM_3_ADDR (CSR_BASE + 0x64L)
#define CSR_MMIO_INST_PWM_3_SIZE 1
static inline uint32_t MMIO_inst_pwm_3_read(void) {
	return csr_read_simple(CSR_BASE + 0x64L);
}
static inline void MMIO_inst_pwm_3_write(uint32_t v) {
	csr_write_simple(v, CSR_BASE + 0x64L);
}
#define CSR_MMIO_INST_PWM_3_WIDTH_OFFSET 0
#define CSR_MMIO_INST_PWM_3_WIDTH_SIZE 16
static inline uint32_t MMIO_inst_pwm_3_width_extract(uint32_t oldword) {
	uint32_t mask = ((uint32_t)(1 << 16)-1);
	return ( (oldword >> 0) & mask );
}
static inline uint32_t MMIO_inst_pwm_3_width_read(void) {
	uint32_t word = MMIO_inst_pwm_3_read();
	return MMIO_inst_pwm_3_width_extract(word);
}
static inline uint32_t MMIO_inst_pwm_3_width_replace(uint32_t oldword, uint32_t plain_value) {
	uint32_t mask = ((uint32_t)(1 << 16)-1);
	return (oldword & (~(mask << 0))) | (mask & plain_value)<< 0 ;
}
static inline void MMIO_inst_pwm_3_width_write(uint32_t plain_value) {
	uint32_t oldword = MMIO_inst_pwm_3_read();
	uint32_t newword = MMIO_inst_pwm_3_width_replace(oldword, plain_value);
	MMIO_inst_pwm_3_write(newword);
}
#define CSR_MMIO_INST_PWM_3_PERIOD_OFFSET 16
#define CSR_MMIO_INST_PWM_3_PERIOD_SIZE 16
static inline uint32_t MMIO_inst_pwm_3_period_extract(uint32_t oldword) {
	uint32_t mask = ((uint32_t)(1 << 16)-1);
	return ( (oldword >> 16) & mask );
}
static inline uint32_t MMIO_inst_pwm_3_period_read(void) {
	uint32_t word = MMIO_inst_pwm_3_read();
	return MMIO_inst_pwm_3_period_extract(word);
}
static inline uint32_t MMIO_inst_pwm_3_period_replace(uint32_t oldword, uint32_t plain_value) {
	uint32_t mask = ((uint32_t)(1 << 16)-1);
	return (oldword & (~(mask << 16))) | (mask & plain_value)<< 16 ;
}
static inline void MMIO_inst_pwm_3_period_write(uint32_t plain_value) {
	uint32_t oldword = MMIO_inst_pwm_3_read();
	uint32_t newword = MMIO_inst_pwm_3_period_replace(oldword, plain_value);
	MMIO_inst_pwm_3_write(newword);
}
#define CSR_MMIO_INST_PWM_4_ADDR (CSR_BASE + 0x68L)
#define CSR_MMIO_INST_PWM_4_SIZE 1
static inline uint32_t MMIO_inst_pwm_4_read(void) {
	return csr_read_simple(CSR_BASE + 0x68L);
}
static inline void MMIO_inst_pwm_4_write(uint32_t v) {
	csr_write_simple(v, CSR_BASE + 0x68L);
}
#define CSR_MMIO_INST_PWM_4_WIDTH_OFFSET 0
#define CSR_MMIO_INST_PWM_4_WIDTH_SIZE 16
static inline uint32_t MMIO_inst_pwm_4_width_extract(uint32_t oldword) {
	uint32_t mask = ((uint32_t)(1 << 16)-1);
	return ( (oldword >> 0) & mask );
}
static inline uint32_t MMIO_inst_pwm_4_width_read(void) {
	uint32_t word = MMIO_inst_pwm_4_read();
	return MMIO_inst_pwm_4_width_extract(word);
}
static inline uint32_t MMIO_inst_pwm_4_width_replace(uint32_t oldword, uint32_t plain_value) {
	uint32_t mask = ((uint32_t)(1 << 16)-1);
	return (oldword & (~(mask << 0))) | (mask & plain_value)<< 0 ;
}
static inline void MMIO_inst_pwm_4_width_write(uint32_t plain_value) {
	uint32_t oldword = MMIO_inst_pwm_4_read();
	uint32_t newword = MMIO_inst_pwm_4_width_replace(oldword, plain_value);
	MMIO_inst_pwm_4_write(newword);
}
#define CSR_MMIO_INST_PWM_4_PERIOD_OFFSET 16
#define CSR_MMIO_INST_PWM_4_PERIOD_SIZE 16
static inline uint32_t MMIO_inst_pwm_4_period_extract(uint32_t oldword) {
	uint32_t mask = ((uint32_t)(1 << 16)-1);
	return ( (oldword >> 16) & mask );
}
static inline uint32_t MMIO_inst_pwm_4_period_read(void) {
	uint32_t word = MMIO_inst_pwm_4_read();
	return MMIO_inst_pwm_4_period_extract(word);
}
static inline uint32_t MMIO_inst_pwm_4_period_replace(uint32_t oldword, uint32_t plain_value) {
	uint32_t mask = ((uint32_t)(1 << 16)-1);
	return (oldword & (~(mask << 16))) | (mask & plain_value)<< 16 ;
}
static inline void MMIO_inst_pwm_4_period_write(uint32_t plain_value) {
	uint32_t oldword = MMIO_inst_pwm_4_read();
	uint32_t newword = MMIO_inst_pwm_4_period_replace(oldword, plain_value);
	MMIO_inst_pwm_4_write(newword);
}
#define CSR_MMIO_INST_PWM_5_ADDR (CSR_BASE + 0x6cL)
#define CSR_MMIO_INST_PWM_5_SIZE 1
static inline uint32_t MMIO_inst_pwm_5_read(void) {
	return csr_read_simple(CSR_BASE + 0x6cL);
}
static inline void MMIO_inst_pwm_5_write(uint32_t v) {
	csr_write_simple(v, CSR_BASE + 0x6cL);
}
#define CSR_MMIO_INST_PWM_5_WIDTH_OFFSET 0
#define CSR_MMIO_INST_PWM_5_WIDTH_SIZE 16
static inline uint32_t MMIO_inst_pwm_5_width_extract(uint32_t oldword) {
	uint32_t mask = ((uint32_t)(1 << 16)-1);
	return ( (oldword >> 0) & mask );
}
static inline uint32_t MMIO_inst_pwm_5_width_read(void) {
	uint32_t word = MMIO_inst_pwm_5_read();
	return MMIO_inst_pwm_5_width_extract(word);
}
static inline uint32_t MMIO_inst_pwm_5_width_replace(uint32_t oldword, uint32_t plain_value) {
	uint32_t mask = ((uint32_t)(1 << 16)-1);
	return (oldword & (~(mask << 0))) | (mask & plain_value)<< 0 ;
}
static inline void MMIO_inst_pwm_5_width_write(uint32_t plain_value) {
	uint32_t oldword = MMIO_inst_pwm_5_read();
	uint32_t newword = MMIO_inst_pwm_5_width_replace(oldword, plain_value);
	MMIO_inst_pwm_5_write(newword);
}
#define CSR_MMIO_INST_PWM_5_PERIOD_OFFSET 16
#define CSR_MMIO_INST_PWM_5_PERIOD_SIZE 16
static inline uint32_t MMIO_inst_pwm_5_period_extract(uint32_t oldword) {
	uint32_t mask = ((uint32_t)(1 << 16)-1);
	return ( (oldword >> 16) & mask );
}
static inline uint32_t MMIO_inst_pwm_5_period_read(void) {
	uint32_t word = MMIO_inst_pwm_5_read();
	return MMIO_inst_pwm_5_period_extract(word);
}
static inline uint32_t MMIO_inst_pwm_5_period_replace(uint32_t oldword, uint32_t plain_value) {
	uint32_t mask = ((uint32_t)(1 << 16)-1);
	return (oldword & (~(mask << 16))) | (mask & plain_value)<< 16 ;
}
static inline void MMIO_inst_pwm_5_period_write(uint32_t plain_value) {
	uint32_t oldword = MMIO_inst_pwm_5_read();
	uint32_t newword = MMIO_inst_pwm_5_period_replace(oldword, plain_value);
	MMIO_inst_pwm_5_write(newword);
}
#define CSR_MMIO_INST_PWM_6_ADDR (CSR_BASE + 0x70L)
#define CSR_MMIO_INST_PWM_6_SIZE 1
static inline uint32_t MMIO_inst_pwm_6_read(void) {
	return csr_read_simple(CSR_BASE + 0x70L);
}
static inline void MMIO_inst_pwm_6_write(uint32_t v) {
	csr_write_simple(v, CSR_BASE + 0x70L);
}
#define CSR_MMIO_INST_PWM_6_WIDTH_OFFSET 0
#define CSR_MMIO_INST_PWM_6_WIDTH_SIZE 16
static inline uint32_t MMIO_inst_pwm_6_width_extract(uint32_t oldword) {
	uint32_t mask = ((uint32_t)(1 << 16)-1);
	return ( (oldword >> 0) & mask );
}
static inline uint32_t MMIO_inst_pwm_6_width_read(void) {
	uint32_t word = MMIO_inst_pwm_6_read();
	return MMIO_inst_pwm_6_width_extract(word);
}
static inline uint32_t MMIO_inst_pwm_6_width_replace(uint32_t oldword, uint32_t plain_value) {
	uint32_t mask = ((uint32_t)(1 << 16)-1);
	return (oldword & (~(mask << 0))) | (mask & plain_value)<< 0 ;
}
static inline void MMIO_inst_pwm_6_width_write(uint32_t plain_value) {
	uint32_t oldword = MMIO_inst_pwm_6_read();
	uint32_t newword = MMIO_inst_pwm_6_width_replace(oldword, plain_value);
	MMIO_inst_pwm_6_write(newword);
}
#define CSR_MMIO_INST_PWM_6_PERIOD_OFFSET 16
#define CSR_MMIO_INST_PWM_6_PERIOD_SIZE 16
static inline uint32_t MMIO_inst_pwm_6_period_extract(uint32_t oldword) {
	uint32_t mask = ((uint32_t)(1 << 16)-1);
	return ( (oldword >> 16) & mask );
}
static inline uint32_t MMIO_inst_pwm_6_period_read(void) {
	uint32_t word = MMIO_inst_pwm_6_read();
	return MMIO_inst_pwm_6_period_extract(word);
}
static inline uint32_t MMIO_inst_pwm_6_period_replace(uint32_t oldword, uint32_t plain_value) {
	uint32_t mask = ((uint32_t)(1 << 16)-1);
	return (oldword & (~(mask << 16))) | (mask & plain_value)<< 16 ;
}
static inline void MMIO_inst_pwm_6_period_write(uint32_t plain_value) {
	uint32_t oldword = MMIO_inst_pwm_6_read();
	uint32_t newword = MMIO_inst_pwm_6_period_replace(oldword, plain_value);
	MMIO_inst_pwm_6_write(newword);
}
#define CSR_MMIO_INST_PWM_7_ADDR (CSR_BASE + 0x74L)
#define CSR_MMIO_INST_PWM_7_SIZE 1
static inline uint32_t MMIO_inst_pwm_7_read(void) {
	return csr_read_simple(CSR_BASE + 0x74L);
}
static inline void MMIO_inst_pwm_7_write(uint32_t v) {
	csr_write_simple(v, CSR_BASE + 0x74L);
}
#define CSR_MMIO_INST_PWM_7_WIDTH_OFFSET 0
#define CSR_MMIO_INST_PWM_7_WIDTH_SIZE 16
static inline uint32_t MMIO_inst_pwm_7_width_extract(uint32_t oldword) {
	uint32_t mask = ((uint32_t)(1 << 16)-1);
	return ( (oldword >> 0) & mask );
}
static inline uint32_t MMIO_inst_pwm_7_width_read(void) {
	uint32_t word = MMIO_inst_pwm_7_read();
	return MMIO_inst_pwm_7_width_extract(word);
}
static inline uint32_t MMIO_inst_pwm_7_width_replace(uint32_t oldword, uint32_t plain_value) {
	uint32_t mask = ((uint32_t)(1 << 16)-1);
	return (oldword & (~(mask << 0))) | (mask & plain_value)<< 0 ;
}
static inline void MMIO_inst_pwm_7_width_write(uint32_t plain_value) {
	uint32_t oldword = MMIO_inst_pwm_7_read();
	uint32_t newword = MMIO_inst_pwm_7_width_replace(oldword, plain_value);
	MMIO_inst_pwm_7_write(newword);
}
#define CSR_MMIO_INST_PWM_7_PERIOD_OFFSET 16
#define CSR_MMIO_INST_PWM_7_PERIOD_SIZE 16
static inline uint32_t MMIO_inst_pwm_7_period_extract(uint32_t oldword) {
	uint32_t mask = ((uint32_t)(1 << 16)-1);
	return ( (oldword >> 16) & mask );
}
static inline uint32_t MMIO_inst_pwm_7_period_read(void) {
	uint32_t word = MMIO_inst_pwm_7_read();
	return MMIO_inst_pwm_7_period_extract(word);
}
static inline uint32_t MMIO_inst_pwm_7_period_replace(uint32_t oldword, uint32_t plain_value) {
	uint32_t mask = ((uint32_t)(1 << 16)-1);
	return (oldword & (~(mask << 16))) | (mask & plain_value)<< 16 ;
}
static inline void MMIO_inst_pwm_7_period_write(uint32_t plain_value) {
	uint32_t oldword = MMIO_inst_pwm_7_read();
	uint32_t newword = MMIO_inst_pwm_7_period_replace(oldword, plain_value);
	MMIO_inst_pwm_7_write(newword);
}
#define CSR_MMIO_INST_ENC_RES_EN_ADDR (CSR_BASE + 0x78L)
...
#define CSR_MMIO_INST_RES_ST_REG_ADDR (CSR_BASE + 0x7cL)
...
#define CSR_MMIO_INST_SG_COUNT_0_ADDR (CSR_BASE + 0x80L)
...
#define CSR_MMIO_INST_SG_COUNT_1_ADDR (CSR_BASE + 0x84L)
...
#define CSR_MMIO_INST_SG_COUNT_2_ADDR (CSR_BASE + 0x88L)
...
#define CSR_MMIO_INST_SG_COUNT_3_ADDR (CSR_BASE + 0x8cL)
...
#define CSR_MMIO_INST_SG_COUNT_4_ADDR (CSR_BASE + 0x90L)
...
#define CSR_MMIO_INST_SG_COUNT_5_ADDR (CSR_BASE + 0x94L)
...
#define CSR_MMIO_INST_SG_COUNT_6_ADDR (CSR_BASE + 0x98L)
#define CSR_MMIO_INST_SG_COUNT_6_SIZE 1
static inline uint32_t MMIO_inst_sg_count_6_read(void) {
	return csr_read_simple(CSR_BASE + 0x98L);
}
#define CSR_MMIO_INST_SG_COUNT_7_ADDR (CSR_BASE + 0x9cL)
#define CSR_MMIO_INST_SG_COUNT_7_SIZE 1
static inline uint32_t MMIO_inst_sg_count_7_read(void) {
	return csr_read_simple(CSR_BASE + 0x9cL);
}
#define CSR_MMIO_INST_SG_COUNT_8_ADDR (CSR_BASE + 0xa0L)
#define CSR_MMIO_INST_SG_COUNT_8_SIZE 1
static inline uint32_t MMIO_inst_sg_count_8_read(void) {
	return csr_read_simple(CSR_BASE + 0xa0L);
}
#define CSR_MMIO_INST_SG_VEL_0_ADDR (CSR_BASE + 0xa4L)
...
#define CSR_MMIO_INST_SG_VEL_1_ADDR (CSR_BASE + 0xa8L)
...
#define CSR_MMIO_INST_SG_VEL_2_ADDR (CSR_BASE + 0xacL)
...
#define CSR_MMIO_INST_SG_VEL_3_ADDR (CSR_BASE + 0xb0L)
...
#define CSR_MMIO_INST_SG_VEL_4_ADDR (CSR_BASE + 0xb4L)
#define CSR_MMIO_INST_SG_VEL_4_SIZE 1
static inline uint32_t MMIO_inst_sg_vel_4_read(void) {
	return csr_read_simple(CSR_BASE + 0xb4L);
}
#define CSR_MMIO_INST_SG_VEL_5_ADDR (CSR_BASE + 0xb8L)
#define CSR_MMIO_INST_SG_VEL_5_SIZE 1
static inline uint32_t MMIO_inst_sg_vel_5_read(void) {
	return csr_read_simple(CSR_BASE + 0xb8L);
}
#define CSR_MMIO_INST_SG_VEL_6_ADDR (CSR_BASE + 0xbcL)
#define CSR_MMIO_INST_SG_VEL_6_SIZE 1
static inline uint32_t MMIO_inst_sg_vel_6_read(void) {
	return csr_read_simple(CSR_BASE + 0xbcL);
}
#define CSR_MMIO_INST_SG_VEL_7_ADDR (CSR_BASE + 0xc0L)
#define CSR_MMIO_INST_SG_VEL_7_SIZE 1
static inline uint32_t MMIO_inst_sg_vel_7_read(void) {
	return csr_read_simple(CSR_BASE + 0xc0L);
}
#define CSR_MMIO_INST_SG_VEL_8_ADDR (CSR_BASE + 0xc4L)
#define CSR_MMIO_INST_SG_VEL_8_SIZE 1
static inline uint32_t MMIO_inst_sg_vel_8_read(void) {
	return csr_read_simple(CSR_BASE + 0xc4L);
}
#define CSR_MMIO_INST_WALLCLOCK_ADDR (CSR_BASE + 0xc8L)
...
#define CSR_MMIO_INST_GPIOS_IN_ADDR (CSR_BASE + 0xccL)
...
#define CSR_MMIO_INST_ENC_COUNT_0_ADDR (CSR_BASE + 0xd0L)
#define CSR_MMIO_INST_ENC_COUNT_0_SIZE 1
static inline uint32_t MMIO_inst_enc_count_0_read(void) {
	return csr_read_simple(CSR_BASE + 0xd0L);
}
#define CSR_MMIO_INST_ENC_COUNT_1_ADDR (CSR_BASE + 0xd4L)
...
#define CSR_MMIO_INST_ENC_COUNT_2_ADDR (CSR_BASE + 0xd8L)
#define CSR_MMIO_INST_ENC_COUNT_2_SIZE 1
static inline uint32_t MMIO_inst_enc_count_2_read(void) {
	return csr_read_simple(CSR_BASE + 0xd8L);
}
#define CSR_MMIO_INST_ENC_COUNT_3_ADDR (CSR_BASE + 0xdcL)
#define CSR_MMIO_INST_ENC_COUNT_3_SIZE 1
static inline uint32_t MMIO_inst_enc_count_3_read(void) {
	return csr_read_simple(CSR_BASE + 0xdcL);
}
#define CSR_MMIO_INST_ENC_COUNT_4_ADDR (CSR_BASE + 0xe0L)
...
#define CSR_MMIO_INST_ENC_COUNT_5_ADDR (CSR_BASE + 0xe4L)
#define CSR_MMIO_INST_ENC_COUNT_5_SIZE 1
static inline uint32_t MMIO_inst_enc_count_5_read(void) {
	return csr_read_simple(CSR_BASE + 0xe4L);
}
#define CSR_MMIO_INST_ENC_COUNT_6_ADDR (CSR_BASE + 0xe8L)
#define CSR_MMIO_INST_ENC_COUNT_6_SIZE 1
static inline uint32_t MMIO_inst_enc_count_6_read(void) {
	return csr_read_simple(CSR_BASE + 0xe8L);
}
#define CSR_MMIO_INST_ENC_COUNT_7_ADDR (CSR_BASE + 0xecL)
#define CSR_MMIO_INST_ENC_COUNT_7_SIZE 1
static inline uint32_t MMIO_inst_enc_count_7_read(void) {
	return csr_read_simple(CSR_BASE + 0xecL);
}
#define CSR_MMIO_INST_ENC_COUNT_8_ADDR (CSR_BASE + 0xf0L)
#define CSR_MMIO_INST_ENC_COUNT_8_SIZE 1
static inline uint32_t MMIO_inst_enc_count_8_read(void) {
