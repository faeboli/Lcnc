...
#define TX_POS_VELOCITY6 (TX_POS_VELOCITY5 + 4)
#define TX_POS_VELOCITY7 (TX_POS_VELOCITY6 + 4)
#define TX_POS_VELOCITY8 (TX_POS_VELOCITY7 + 4)
#define TX_POS_MAX_ACC0 (TX_POS_VELOCITY8 + 4)
...
#define TX_POS_MAX_ACC6 (TX_POS_MAX_ACC5 + 4)
#define TX_POS_MAX_ACC7 (TX_POS_MAX_ACC6 + 4)
#define TX_POS_MAX_ACC8 (TX_POS_MAX_ACC7 + 4)
//  - other registers, only one each needed, max 16 STEPGENS allowed
#define TX_POS_STEP_RES_EN (TX_POS_MAX_ACC8 + 4)
...
#define TX_POS_PWM6 (TX_POS_PWM5 + 4)
#define TX_POS_PWM7 (TX_POS_PWM6 + 4)
// end of PWM related regs
// Encoder control, one register needed, maximum 16 encoders allowed
#define TX_POS_ENC_RES_EN (TX_POS_PWM7 + 4)
...
#define RX_POS_STEPCOUNT6 (RX_POS_STEPCOUNT5 + 4)
#define RX_POS_STEPCOUNT7 (RX_POS_STEPCOUNT6 + 4)
#define RX_POS_STEPCOUNT8 (RX_POS_STEPCOUNT7 + 4)
#define RX_POS_STEPVEL0 (RX_POS_STEPCOUNT8 + 4)
...
#define RX_POS_STEPVEL6 (RX_POS_STEPVEL5 + 4)
#define RX_POS_STEPVEL7 (RX_POS_STEPVEL6 + 4)
#define RX_POS_STEPVEL8 (RX_POS_STEPVEL7 + 4)
// end of STEPGEN related regs
// WALLCLOCK feedback register, only one needed
#define RX_POS_WALLCLOCK (RX_POS_STEPVEL8 + 4)
...
#define RX_POS_ENCCOUNT6 (RX_POS_ENCCOUNT5 + 4)
#define RX_POS_ENCCOUNT7 (RX_POS_ENCCOUNT6 + 4)
#define RX_POS_ENCCOUNT8 (RX_POS_ENCCOUNT7 + 4)
// end of ENCODER related regs
// number of registers to be sent read from fpga, sum of all the ones so far
#define RX_PAYLOAD_SIZE (RX_POS_ENCCOUNT8 + 4)
